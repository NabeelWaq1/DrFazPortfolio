...
containerRef.current.classList.remove("show-controls")
  ...
  return (
    <div onClick={(e) => checkClick(e)} className='w-full min-h-screen overflow-x-hidden'>
      ...
      {/* Section 3 */}
      <div className='bg-background w-full min-h-screen flex flex-col justify-center items-center py-20 gap-0 sm:gap-4 md:gap-8 px-5'>
        ...
        <div onMouseMove={() => showControls()} ref={containerRef} className="container w-full md:w-[800px] h-[300px] sm:h-[500px] relative rounded-lg bg-black">
