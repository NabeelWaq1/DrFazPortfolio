...
const About = () => {
  return (
    ...
    <div className="w-full mt-[150px] lg:mt-0 h-screen sm:h-[115vh] lg:h-[100vh] overflow-hidden bg-fixed bg-[url('/src/assets/aboutpage2.png')] contrast-125 relative bg-no-repeat bg-cover">
      ...
      {/* Section 2 */}
      <div className="w-full h-[80vh] md:min-h-[120vh] bg-[url('/src/assets/about2.jpg')] contrast-150 relative bg-cover bg-center flex justify-between items-center">
      <div className="w-full h-full bg-background absolute top-0 left-0 bg-opacity-50 z-10"></div>
      <div className="w-full min-h-full flex items-center justify-center gap-6 flex-col relative z-[18] bg-primary bg-opacity-50 md:rounded-3xl">
        <h2 className='text-center text-3xl sm:text-4xl md:text-5xl text-secondary font-semibold tracking-wider [text-shadow:_0_6px_8px_#fff]'>A Journey of<br />
      ...
      {/* Section 4 */}
      <div className="w-full min-h-screen flex flex-col md:flex-row justify-center md:justify-end items-center px-12 py-16 md:px-8 bg-[url('/src/assets/aboutpage7.png')] bg-fixed bg-no-repeat bg-left mt-20 md:bg-top md:py-28 bg-cover">
