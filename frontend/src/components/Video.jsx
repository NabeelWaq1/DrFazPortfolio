...
const Video = ({videoRef,videoSrc,thumb}) => {
...
<video onLoadedData={(e) => updateDuration(e)} onTimeUpdate={(e) => timeUpdate(e)} ref={videoRef} className='w-full h-full px-2 rounded-lg' src={videoSrc}></video>
    )}
